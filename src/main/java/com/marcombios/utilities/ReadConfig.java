...
public class ReadConfig {
	...
	{
	String listURL=pro.getProperty("listURL");
	return listURL;
	}
	
	public String getPrimaryRecycleBinURL()
	{
	String primaryRecycleBinURL=pro.getProperty("primaryrecyclebinURL");
	return primaryRecycleBinURL;
	}
	...
	public String getMarcomUsername()
	{
	String webmasterusername=pro.getProperty("marcomusername");
	return webmasterusername;
	}
	
	public String getMarcomEditorUsername()
	{
	String webmasterusername=pro.getProperty("marcomeditorusername");
	return webmasterusername;
	}
	...
	{
	String userFile=pro.getProperty("userdata");
	return userFile;
	}
